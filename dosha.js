        ...
        setTimeout(function(){
            ...
            if((questionNo + 1) > q.length){
                ...
                setTimeout(function(){
                    ...
                    if(Dosha=="Vatta")
                        var toAppend = '<tr><td>The Vata dosha comprises of the following elements - air and ether. This means that the individual will exhibit the qualities of these elements</td><td valign="middle"><a target="_blank" class="btn btn-primary" href="https://www.jiva.com/blog/how-to-reduce-vata-dosha-in-your-body" role="button">Read More</a></td></tr>';
                    if(Dosha=="Pitta")
                        var toAppend = '<tr><td>The Pitta dosha comprises of the following elements - fire and water. Fire is more predominant, and those people with a dominant Pitta nature have many of the qualities of fire within them.</td><td valign="middle"><a target="_blank" class="btn btn-primary" href="https://www.artofliving.org/in-en/ayurveda/ayurvedic-treatments/pitta-imbalance-manage" role="button">Read More</a></td></tr>';
                    if(Dosha=="Kapha")
                        var toAppend = '<tr><td>The Kapha dosha comprises of the following elements - water and earth. Like these elements, Kapha tends to be cool, moist, stable and heavy.</td><td valign="middle"><a target="_blank" class="btn btn-primary" href="https://www.banyanbotanicals.com/info/ayurvedic-living/learning-ayurveda/balancing-kapha/" role="button">Read More</a></td></tr>';
